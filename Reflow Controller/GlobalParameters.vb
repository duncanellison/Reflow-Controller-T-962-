...
Public Class GlobalParameters
    ...
    ' Profile names - note these have to wait to be retrieved from the oven as they are used 
    Public Shared ProfileName0 As String = "Unknown"
    Public Shared ProfileName1 As String = "Unknown"
    Public Shared ProfileName2 As String = "Unknown"
    Public Shared ProfileName3 As String = "Unknown"
    Public Shared ProfileName4 As String = "Unknown"
    Public Shared ProfileName5 As String = "Unknown"
    Public Shared ProfileName6 As String = "Unknown"
    ...
    Public Shared OvenType As String = 0
    ...
    Public Shared TC1Name As String = ""
    Public Shared TC2Name As String = ""
    Public Shared TC3Name As String = ""
    Public Shared TC4Name As String = ""
